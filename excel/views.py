...
def export_excel_reservations(request):
    ...
    if request.method == "GET":
        ...
        columns = ["id", "pickUpTime", "dropOffTime", "car_id", "user_id", "pickUpLocation",
        ...
        rows = Reservation.objects.all().values_list("id", "pickUpTime", "dropOffTime", "car_id", "user_id", "pickUpLocation",
                   "dropOffLocation", "status", "totalPrice")
